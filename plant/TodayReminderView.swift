...
struct TodayReminderView_Previews: PreviewProvider {
    ...
    @State static var dummyReminders = [
        ReminderItem(name: "Monstera", location: "in Kitchen", light: "Full sun", waterAmount: "20-50 ml"),
        ReminderItem(name: "Pothos", location: "in Bedroom", light: "Full sun", waterAmount: "20-50 ml"),
        ReminderItem(name: "Orchid", location: "in Living Room", light: "Full sun", waterAmount: "20-50 ml"),
        ReminderItem(name: "Spider", location: "in Kitchen", light: "Full sun", waterAmount: "20-50 ml")
    ]
